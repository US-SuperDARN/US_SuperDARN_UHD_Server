...
void write_clr_freq_bin(char *filename, char *ststr, int channel, int beam_num, freq_band *clr_band, int *clr_range, double *clr_spectrum, double *freq_vector, int num_samples);
